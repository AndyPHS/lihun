...
.c_m_h_r .help{width: 151px;height: 35px;text-align: center;line-height: 35px;font-size:16px;color:#535353;font-weight: bold;display: initial;text-decoration: underline;}
