<template>
  <div>
    ...
    <div class="fuwu">
      <div class="head_com">
        <h2>专业的离婚协议书服务</h2>
        <span>基于家理起草的超过1000份离婚协议书研发</span>
      </div>
      <div class="w flex justify-between">
        <dl class="w-1/5">
          <dt>
      ...
      <div class="w guanyu_min flex justify-between">
        ...
        <div class="guanyu_min_r">
          <div class="guanyu_min_r_con">
            <p>家理始终坚持将细节做到极致，始终以工匠品质办案。 </p>
            <p>家理团队精心研究大量文书案例，将每份文书的个性和共性归纳总结。</p>
            <div class="luo">
              <span class="blu"></span>
              <h5>北京家理律师事务所</h5>
            </div>
    ...
    <div class="qianyue">
      ...
      <div class="w quanyue_01 flex justify-between">
        <dl class="w-1/4 mr-4">
          <dt>10+年</dt>
          <dd>
            <p>团队专注婚姻家事法律服务10+年</p>
          </dd>
        </dl>
        <dl class="w-1/4 mr-4">
          <dt>20000+咨询</dt>
          <dd>
            <p>每年有近3万的当事人咨询家理婚 姻家事法律问题</p>
          </dd>
        </dl>
        <dl class="w-1/4 mr-4">
          <dt>3000+委托</dt>
          <dd>
            <p>成立于2016年2月17日，从成立起 专注于婚姻家事法律服务</p>
          </dd>
        </dl>
        <dl class="w-1/4">
          <dt>数据安全</dt>
          <dd>
            <p>每年有超过1万人咨询家理婚姻家 事法律问题</p>
          </dd>
        </dl>
      </div>
...
.fuwu dl dd p{color:#535353;width: 147px;margin:0 auto;font-size: 16px;display: -webkit-inline-box;}
.guanyu_min_r{width: 600px;height: 337px;background: #f2f4f7;}
.guanyu_min_r .guanyu_min_r_con{width: 100%;height: 100%;padding:45px;position: relative;font-size:16px;color:#737374;text-align: left;}
.luo{position: absolute;bottom: 45px;right: 45px;text-align: right;}
.luo .blu{width: 80px;height: 3px;background:darkblue;margin-bottom: 10px;display: inline-block;}
