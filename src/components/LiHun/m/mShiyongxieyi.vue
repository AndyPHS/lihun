<template>
	<div class="mshiyongxieyi">
		<div class="com_head mx-3 border-b border-gray-400 relative">
			<img @click="gohome" src="../../../assets/images/lihun/m/back_icon.png" alt="">
			<h2 class="py-4 text-bold text-center text-xl">蜗牛家事用户注册和使用协议</h2>
		</div>
		<div class="min px-3 text-left py-3">
			<p style="text-indent:28px">
			    <strong><span style=";color:black">【审慎阅读】</span></strong><span style=";color:#404040">在您申请注册流程中点击同意前，应当认真阅读以下协议。</span><strong><span style="text-decoration:underline;"><span style=";color:black">请您务必审慎阅读、充分理解协议中相关条款内容。</span></span></strong>
			</p>
			<p style="text-indent:28px">
			    <span style=";color:#404040">如您对协议有任何疑问，可向客服咨询。</span>
			</p>
			<p style="text-indent:28px">
			    <strong><span style=";color:black">【特别提示】</span></strong><span style=";color:#404040">当您按照注册页面提示填写信息、阅读并同意协议且完成全部注册程序后，即表示您已充分阅读、理解并接受协议的全部内容。</span>
			</p>
			<p style="text-indent:28px">
			...
			<p>
			    &nbsp; &nbsp;&nbsp;&nbsp;请您确认，在您开始注册程序使用蜗牛家事前，您应当具备中华人民共和国法律规定的与您行为相适应的民事行为能力。若您不具备前述与您行为相适应的民事行为能力，则您及您的监护人应依照法律规定承担因此而导致的一切后果。
			</p>
			<p style="text-indent:28px">
			    （二）注册信息
			</p>
			...
			<p>
			    &nbsp; &nbsp;&nbsp;&nbsp;本协议内容包括以下条款及已经发布的或将来可能发布的各类规则。所有规则为本协议不可分割的一部分，与协议正文具有同等法律效力。蜗牛家事有权根据需要不定时地制定、修改本协议或各类规则，如本协议及规则有任何变更，一切变更以本网站最新公布的内容为准。经修订的协议、规则一经公布，立即自动生效，对新协议、规则生效之后注册的用户发生法律效力。对于协议、规则生效之前注册的用户，若用户在新规则生效后继续使用本网站提供的各项服务，则表明用户已充分阅读并认可和同意遵守新的协议或规则。若您拒绝接受新的协议和规则，您必须放弃使用蜗牛家事提供的各项服务（包括但不限于使用用户名和密码登录蜗牛家事、进行定制或修改操作等）。
			</p>
			<p>
			    &nbsp;
			</p>
			...
			<p>
			    &nbsp; &nbsp;&nbsp;&nbsp;（二）您因使用蜗牛家事服务所产生及与蜗牛家事服务有关的争议，由蜗牛家事与您协商解决。协商不成时，任何一方均可向被告所在地有管辖权的人民法院提起诉讼。
			</p>
			<p>
			    &nbsp; &nbsp;&nbsp;&nbsp;（三）本协议任一条款被视为废止、无效或不可执行，该条应视为可分的且并不影响本协议其余条款的有效性及可执行性。
			</p>
			<p>
			    &nbsp;
			</p>
			...
			<p>
			    &nbsp; &nbsp;&nbsp;&nbsp;2.1 蜗牛家事可根据相应规则立即对相应信息进行删除、屏蔽处理。
			</p>
			<p>
			    &nbsp; &nbsp;&nbsp;&nbsp;2.2 您在蜗牛家事实施的行为，蜗牛家事可依据相应规则对您执行账户中止向您提供部分或全部服务等处理措施。如您的行为构成根本违约的，蜗牛家事可查封您的账户，终止向您提供服务。&nbsp;
			</p>
			<p style="text-indent:28px">
			    （三）赔偿责任
			</p>
