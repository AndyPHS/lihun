		...
		<div class="queding_head">
			...
			<div class="px-2">
				<ul class="flex justify-around">
					<li class="text-base active_nav text-white">热门</li>
...
<style scoped="scoped">
	...
	.nav_list{background-color: #e5e5e5;-webkit-box-sizing: border-box;box-sizing: border-box;overflow: hidden;}
